...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const payload = {
      click_id: clickId || (typeof crypto !== 'undefined' && crypto.randomUUID ? crypto.randomUUID() : `vis-${Date.now()}`),
      aff_id: affId || '',
      offer_id: offerId || '',
      sub_id: subId || '',
      sub_id_2: subId2 || '',
      is_mobile: !!isMobile,
      used_for_pixel_firing: false, // safe default
