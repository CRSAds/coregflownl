...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // -----------------------------------------------------------
  // 🔹 Globale trigger — coreg-leads versturen zodra shortform voltooid is
  // -----------------------------------------------------------
    ...
    try {
      ...
      for (const key of allKeys) {
        ...
        if (!cid || cid === "null" || cid === "undefined") {
          console.warn(`⚠️ Ongeldige coreg key: ${key}`);
          continue;
        }
        ...
        console.log("📦 Coreg payload gereed voor verzending:", payload);
