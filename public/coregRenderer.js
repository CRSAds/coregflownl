// =============================================================
// ✅ coregRenderer.js — coreg_answer + multistep + juiste longform timing
//    + ondersteuning voor coreg vóór/na shortform (pendingShortCoreg)
...
// 🔧 Logging toggle
// =============================================================
const DEBUG = true; // ← Zet op true bij testen
